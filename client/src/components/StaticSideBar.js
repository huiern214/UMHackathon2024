...
function StaticSideBar({
  ...
  return (
    <div className="flex flex-col items-center w-[3%] h-full bg-grayWhite ">
      <button
        className={`hover:scale-105 transition-transform  flex w-full justify-center ${
          activeSideBar === "updateTransaction"
      ...
      <button
        ...
        onClick={() => handleActiveSideBar("analysis")}
      >
      ...
      <button
        ...
        onClick={() => handleActiveSideBar("chatHistory")}
      >
